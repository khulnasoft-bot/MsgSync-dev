...
async function runHolidayCampaign() {
    ...
    try {
        ...
        const listResp = await axios.post(`${API_BASE}/lists`, { name: 'Holiday Shoppers' }, HEADERS);
        ...
        const holidayTemplate = "Season's Greetings {{firstName}}! ❄️ Gift yourself with our Winter Sale. Use code {{code}} for {{off}} OFF everything! Valid until Jan 5. Shop now: https://example.com/sale";
