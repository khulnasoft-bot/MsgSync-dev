...
async function runSecurityCampaign() {
    ...
    try {
        ...
        const listResp = await axios.post(`${API_BASE}/lists`, { name: 'Security Notifications' }, HEADERS);
        ...
        const securityTemplate = "Security Alert: Hi {{firstName}}, a new login was detected for your account from {{device}} in {{location}}. If this wasn't you, secure your account immediately: https://msgsync.com/secure";
